    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("""
                    ...
                    31. update House
                    --------------------
                    32. get All RentInfo Between Dates
                    33. houses By Agency Id And Date
                    """);
            switch (new Scanner(System.in).nextLine()) {
                ...
                case "20" -> {
                    System.out.println(ownerService.deleteOwner(8L));
                }
                case "21" -> {
                    System.out.println(ownerService.getOwnersByAgencyId(3L));
                }
                case "22" -> {
                ...
                case "24" -> {
                    House house = new House(HouseType.HOUSE, new BigDecimal(450.00000), 8, "good", 7, false,
                            new Address("Tokio", "Akihabara", "rrr"),
                ...
                case "25" -> {
                    System.out.println(houseService.deleteHouse(9L));
                }
                case "26" -> {
                    System.out.println(houseService.getAllHousesByRegion("Akihabara"));
                }
                case "27" -> {
                    System.out.println(houseService.getAllHouseByAgencyId(3L));
                }
                case "28" -> {
                ...
                case "30" -> {
                    System.out.println(houseService.getHouseById(1L));
                }
                case "31" -> {
                    House house = new House(HouseType.HOUSE, new BigDecimal(700.00000), 5, "perfecto", 15, true,
                            new RentInfo(LocalDate.of(2024, 2, 10), LocalDate.of(2024, 8, 26)));
                    System.out.println(houseService.updateHouse(11L, house));
                }
                case "32" -> {
                    System.out.println(rentInfoService.getAllRentInfoBetweenDates(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 5, 5)));
                }
                case "33" -> {
                    System.out.println(rentInfoService.housesByAgencyIdAndDate(3L));
                }
            }
        }
    }
